...
//===================================================================
const u8 gfontArial10[255][32] = {
    #include "Arial10B.c"
};

font_type fontArial10 = {
    14,                   // Ширина шрифта в пикселях в массиве шрифта
    16,                   // Высота шрифта в пикселях в массиве шрифта  
    10,                    // Ширина символов '.' ',' ':' ';' при выводе на дисплей 
    14,                   // Ширина всех остальных символов  при выводе на дисплей    
    &gfontArial10[0][0]
};
