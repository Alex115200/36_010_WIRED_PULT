...
*/
    ...
    #else
        #define		App_TaskCreateHook(a)
        #define		App_TaskDelHook(a)
        #define		App_TaskIdleHook()

        #define		App_TaskReturnHook(a)

        #define		App_TaskStatHook()
    #endif
