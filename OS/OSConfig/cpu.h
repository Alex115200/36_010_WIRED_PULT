...
#define  CPU_REG_NVIC_INT_TYPE          (*((volatile CPU_INT32U *)(0xE000E004))) /* Int Ctrl'er Type Reg.              */
...
#define  CPU_REG_NVIC_ST_CAL            (*((volatile CPU_INT32U *)(0xE000E01C))) /* SysTick Calibration Value Reg.     */
                                                                                 /* IRQ Set En Reg.                    */
#define  CPU_REG_NVIC_EN(n)             (*((volatile CPU_INT32U *)(0xE000E100 + (n) * 4)))
                                                                                 /* IRQ Clr En Reg.                    */
#define  CPU_REG_NVIC_DIS(n)            (*((volatile CPU_INT32U *)(0xE000E180 + (n) * 4)))
                                                                                 /* IRQ Set Pending Reg.               */
#define  CPU_REG_NVIC_PEND(n)           (*((volatile CPU_INT32U *)(0xE000E200 + (n) * 4)))
                                                                                 /* IRQ Clr Pending Reg.               */
#define  CPU_REG_NVIC_UNPEND(n)         (*((volatile CPU_INT32U *)(0xE000E280 + (n) * 4)))
                                                                                 /* IRQ Active Reg.                    */
...
#define  CPU_REG_NVIC_INT_CTRL          (*((volatile CPU_INT32U *)(0xE000ED04))) /* Int Ctrl State  Reg.               */
#define  CPU_REG_NVIC_VTABLE            (*((volatile CPU_INT32U *)(0xE000ED08))) /* Vect Tbl Offset Reg.               */
#define  CPU_REG_NVIC_APINT             (*((volatile CPU_INT32U *)(0xE000ED0C))) /* App Int/Reset Ctrl Reg.            */
#define  CPU_REG_NVIC_SYS_CTRL          (*((volatile CPU_INT32U *)(0xE000ED10))) /* System Ctrl Reg.                   */
#define  CPU_REG_NVIC_CFG_CTRL          (*((volatile CPU_INT32U *)(0xE000ED14))) /* Cfg    Ctrl Reg.                   */
#define  CPU_REG_NVIC_SYS_PRI1          (*((volatile CPU_INT32U *)(0xE000ED18))) /* System Handlers  4 to  7 Prio.     */
#define  CPU_REG_NVIC_SYS_PRI2          (*((volatile CPU_INT32U *)(0xE000ED1C))) /* System Handlers  8 to 11 Prio.     */
#define  CPU_REG_NVIC_SYS_PRI3          (*((volatile CPU_INT32U *)(0xE000ED20))) /* System Handlers 12 to 15 Prio.     */
#define  CPU_REG_NVIC_SYS_HND_CTRL      (*((volatile CPU_INT32U *)(0xE000ED24))) /* System Handler Ctrl & State Reg.   */
#define  CPU_REG_NVIC_FAULT_STAT        (*((volatile CPU_INT32U *)(0xE000ED28))) /* Configurable Fault Status Reg.     */
#define  CPU_REG_NVIC_HFAULT_STAT       (*((volatile CPU_INT32U *)(0xE000ED2C))) /* Hard  Fault Status Reg.            */
#define  CPU_REG_NVIC_DEBUG_STAT        (*((volatile CPU_INT32U *)(0xE000ED30))) /* Debug Fault Status Reg.            */
#define  CPU_REG_NVIC_MM_ADDR           (*((volatile CPU_INT32U *)(0xE000ED34))) /* Mem Manage Addr Reg.               */
#define  CPU_REG_NVIC_FAULT_ADDR        (*((volatile CPU_INT32U *)(0xE000ED38))) /* Bus Fault  Addr Reg.               */
#define  CPU_REG_NVIC_AUX_FAULT_STAT    (*((volatile CPU_INT32U *)(0xE000ED3C))) /* Aux Fault Status Reg.              */
